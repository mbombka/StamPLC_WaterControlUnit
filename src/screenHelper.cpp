...
static void showStatus1(float heaterSetTemperature, float temperature1, float temperature2, bool pumpHotWaterIsOn, bool pumpCirculationIsOn, bool pumpFloorHeatingIsOn){
...
static void showStatus2(int actualMode, int bathStep, bool wifiConnected ){
