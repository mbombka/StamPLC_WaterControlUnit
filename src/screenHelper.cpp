...
static void showSensorStatus(float temperature1, float temperature2, bool pumpHotWaterIsOn, bool pumpCirculationIsOn, bool pumpHeating1IsOn, bool pumpHeating2IsOn){
    M5StamPLC.Display.clear(TFT_BLACK);
    M5StamPLC.Display.setCursor(0, 10);
    M5StamPLC.Display.setTextColor(TFT_WHITE);
    ...
    M5StamPLC.Display.printf(" Pompa parteru: %s\n", pumpHeating1IsOn? "ON":"OFF");
    M5StamPLC.Display.printf(" Pompa pietra: %s\n", pumpHeating2IsOn? "ON":"OFF");
    delay(5000);
}
